...
func init() {
	configCmd.PersistentFlags().StringVarP(&CH_CONN, "set-clickhouse", "c", "", "sets the clickhouse connection url")
	configCmd.PersistentFlags().StringVarP(&QT_CONN, "set-server", "s", "", "sets the quality trace connection url")
